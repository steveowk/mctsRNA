...
args.add_argument('-t', '--test_mode',  type=bool, help="test MCTS", default=True)
...
args.add_argument('-p', '--workers', type=int, help="num processors", default=10)
...
def runner():
    Parallel(n_jobs=args.workers, verbose=5)(delayed(seq_processor)(seq) for seq in dataset)
